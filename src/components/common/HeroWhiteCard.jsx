...
const HeroWhiteCard = () => {
  ...
  return (
    <div className="bg-white sm:p-5 p-2 sm:rounded-[30px] rounded-[10px] w-full xl:max-w-[450px] sm:max-w-[400px] xl:min-w-[450px] sm:min-w-[400px] min-w-[250px] mx-auto mt-2 ">
